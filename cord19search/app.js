    ...
    $('#container').html(function () {
        return $.map(content.hits, function (hit) {
            ...
            if (window.displayAttributes.indexOf('section_text') > -1){
                ...
                strSectionText = '';
                var sectionTextValue = hit._highlightResult.section_text;
                if (Array.isArray(sectionTextValue)){
                    for(var item in sectionTextValue){
                        strSectionText += sectionTextValue[item].value + ' ';
                    }
                }
                else{
                    strSectionText = sectionTextValue;
                }
